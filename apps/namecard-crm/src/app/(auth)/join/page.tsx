  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[400px] bg-blue-600/8 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-sm">
        ...
        {state === 'invalid' && (
          <div className="bg-gray-800/60 border border-gray-700/50 rounded-2xl p-6 text-center space-y-4">
            ...
            <Link href="/login" className="text-sm text-blue-400 hover:text-blue-300">로그인 페이지로</Link>
          </div>
        )}
        ...
        {(state === 'valid' || state === 'submitting') && (
          <div className="bg-gray-800/60 border border-gray-700/50 rounded-2xl p-6 backdrop-blur-sm">
            <div className="mb-5 p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl">
              <p className="text-sm text-blue-300 font-medium">{tenantName}</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className={cn(
                  'w-full py-2.5 rounded-xl text-sm font-semibold bg-blue-600 hover:bg-blue-500 text-white',
                  'disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg shadow-blue-600/20',
                )}
              >
