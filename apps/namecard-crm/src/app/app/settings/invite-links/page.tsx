              ...
              <div className="flex items-start justify-between gap-3">
                ...
                {link.is_active && (
                  <div className="flex items-center gap-1.5 shrink-0">
                    <button onClick={() => handleCopy(link)} className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-dk-blue border border-dk-border rounded-lg hover:bg-dk-surface2 transition-colors">
